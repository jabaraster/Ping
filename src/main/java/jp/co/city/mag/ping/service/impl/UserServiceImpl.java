...
public class UserServiceImpl extends JpaDaoBase implements IUserService {
    private static final long serialVersionUID = 8696824714400656708L;
    ...
    /**
     * @see jp.co.city.mag.ping.service.IUserService#getAll(jabara.general.Sort)
     */
    @Override
    ...
    /**
     * @see jp.co.city.mag.ping.service.IUserService#insertAdministratorIfNotExists()
     */
    @Override
